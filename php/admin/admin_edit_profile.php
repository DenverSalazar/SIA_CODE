        ...
        if(in_array(strtolower($filetype), $allowed)){
            ...
            if(move_uploaded_file($_FILES['profile_picture']['tmp_name'], $upload_path)){
                ...
                if($role == 'student'){
                    ...
                    $update_query = "UPDATE admin SET fName='$fName', lName='$lName', 
                                   email='$email', profile_picture='$new_filename' 
                                   WHERE id='$id'";
                }
            } else {
    ...
    if(!empty($update_query)){
        try {
            if(mysqli_query($con, $update_query)){
                ...
                header("Location: admin_profile.php"); // Modified redirect path
                exit();
            } else {
            ...
            <div class="edit-form">
                ...
                <div class="profile-upload">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="admin_profile.php" class="cancel-btn link-underline link-underline-opacity-0">
