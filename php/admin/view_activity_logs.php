    ...
    <div class="container mt">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="bookshelf-title">Activity Logs of Student <?php echo htmlspecialchars($student_info['fName'] . ' ' . $student_info['lName']); ?></h1>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="3" class="text-center">No activity logs found for this filter.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
